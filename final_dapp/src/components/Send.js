  ...
  return (
    <div className="flex flex-col justify-center items-center text-white">
      ...
      <div className="flex w-3/5 justify-between items-center mt-5 ml-5">
          <input onChange={(e) => App.setRecipientAddress(e.target.value)} value={App.recipientAddress} className="w-3/4 p-3 bg-black border-2 border-blue-900 border-opacity-60 bg-opacity-70 outline-none rounded-lg" placeholder={"Address"} />
          <input onChange={(e) => App.setAmount(e.target.value)} value={App.amount} type={"number"} className="w-1/4 p-3 bg-black border-2 border-blue-900 border-opacity-60 bg-opacity-70 outline-none rounded-lg ml-2" placeholder={"Amount"} />
        </div>
        ...
        <div onClick={App.transferAmount} className="flex mt-4 w-3/5 cursor-pointer justify-center items-center p-2 bg-green-700 bg-opacity-70 border-2 border-blue-900 border-opacity-80 text-xl font-medium rounded-lg">
        Transfer
        </div>}
        {/* Recent Tx section */}
